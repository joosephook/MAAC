...
from utils.critics import AttentionCritic, SelectiveAttentionCritic
...
class SelectiveAttentionSAC(object):
    """
    Wrapper class for SAC agents with central attention critic in multi-agent
    task
    """
    def __init__(self, agent_init_params, sa_size,
        ...
        self.critic = SelectiveAttentionCritic(sa_size, widths=widths, hidden_layers=hidden_layers, selector_width=2, selector_depth=2)
        self.target_critic = SelectiveAttentionCritic(sa_size, widths=widths, hidden_layers=hidden_layers, selector_width=2, selector_depth=2)
        hard_update(self.target_critic, self.critic)
        self.critic_optimizer = Adam(self.critic.parameters(), lr=q_lr,
                                     weight_decay=1e-3)
        self.agent_init_params = agent_init_params
